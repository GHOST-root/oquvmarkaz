    ...
    <div className="dashboard-card mb-4" style={{ animation: 'fadeInDown 0.3s ease' }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div>
          <h5 className="m-0 text-dark fw-semibold">
            Guruhni tark etgan o'quvchilar <span className="text-muted fs-6 ms-2">Miqdor — {students.length}</span>
          </h5>
        </div>
      ...
      <div className="row g-2 mb-4 align-items-center">
        ...
        <div className="col-md-2">
          <select className="form-select form-select-sm text-muted"><option>Faol</option></select>
        </div>
        <div className="col-md-2">
        ...
        <table className="table table-hover align-middle mb-0" style={{fontSize: '13px'}}>
          ...
          <tbody>
            {students.length > 0 ? students.map((student, index) => (
              <tr key={student.id}>
                <td>{index + 1}</td>
                {/* Havolaga o'xshash havorang yozuvlar */}
                ...
                {/* Mock data: Bazada bo'lmasa standart sabab yozib turamiz */}
              ...
              <tr>
                <td colSpan="10" className="text-center py-5 text-muted">Guruhni tark etgan o'quvchilar yo'q.</td>
              </tr>
            )}
          </tbody>
        </table>
