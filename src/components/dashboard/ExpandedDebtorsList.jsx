  ...
  return (
    <div className="dashboard-card mb-4" style={{ animation: 'fadeInDown 0.3s ease' }}>
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div><h5 className="m-0 text-dark fw-semibold">Qarzdorlar <span className="text-muted fs-6 ms-2">Miqdor — {debtors.length}</span></h5></div>
          ...
          <tbody>
            {sortedDebtors.map((student) => (
              <tr key={student.id} style={{ cursor: 'pointer' }}>
                ...
                <td><div style={{width: '20px', height: '20px', borderRadius: '50%', backgroundColor: student.status === 'Faol' ? '#10B981' : '#9CA3AF'}}></div></td>
                <td>
                  <div className="d-flex gap-2 text-warning fs-6"><i className="fa-regular fa-clock cursor-pointer"></i><i className="fa-regular fa-flag cursor-pointer"></i></div>
                </td>
              </tr>
            ))}
          </tbody>
